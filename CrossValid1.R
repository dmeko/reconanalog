CrossValid1<- function(X, y, nNeg, nPos, i2) {
  # Leave-m-out cross-validatin of a previously estimated stepwise regression model. 
  # D Meko
  # last revised 2021 May 26
  #
  # IN
  ...
  #   in calling script or function; that order is repeated here
  # 
  # OUT
  ...
  #   vector REcvAll of RE at each step of the modeling
  ...
  CV <- list("REmaxStep"=kmax,"ColumnsIn"=i2cv,"REcvAll"=REall,"REcv"=REwinner,
             "CVpredictions"=Pcv,"CVresiduals"=Ecv,"RMSEcv"=RMSEcv,
             "LeftOut"=mOut)
  return(CV)
}