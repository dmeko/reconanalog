mannken1 <- function(Din){
  ...
  #   2 Likewise plot time series with fitted trend line; but this is TRISH-specific,
  #     intended for looking at trend in regressio residuals in context of other
  #     calls; horiz line at 0, and file named like "Figure??.png, with name controlled 
  #     by input specs
  #   3 The GEOS85 2x1 plot of trend-fit to time series (top) and detrended series (bottom)
  ...
  if (m==0){
    ...
    if (kopt[1]==2){
      ...
      if (kplot==3){
        ...
        #--- Build time plot of time sries with trend line and annotation
        png(filename=fileOut, width = 960, height = 480)
